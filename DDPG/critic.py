...
class Critic:
    ...
    def network(self):
        ...
        x1 = Dense(512, activation='linear', kernel_initializer='he_uniform')(state)
        x1 = BatchNormalization()(x1)
        x2 = Dense(512, activation='linear', kernel_initializer='he_uniform')(action)
        x2 = BatchNormalization()(x2)
        x = concatenate([Flatten()(x1), x2])
        x = Dense(256, activation='relu', kernel_initializer='he_uniform')(x)
        x = BatchNormalization()(x)
        out = Dense(1, activation='linear', kernel_initializer='he_uniform')(x)
